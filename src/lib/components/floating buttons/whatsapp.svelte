<script>
	const chatLink = 'https://wa.me/9660581222287'; // Replace with your WhatsApp chat link
</script>
...
<a
	...
	class="fixed bottom-6 left-4 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-transform transform hover:scale-110"
